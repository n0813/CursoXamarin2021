...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "MiPrimeraAppEnXamarinForms.Android.dll" comes first in this list. */
		"MiPrimeraAppEnXamarinForms.Android.dll",
		"FormsViewGroup.dll",
		"MiPrimeraAppEnXamarinForms.dll",
